  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <header className="border-b border-border bg-card">
        <div className={`${activeTab === "jobs" ? "max-w-7xl" : "max-w-6xl"} mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between transition-all`}>
      ...
      {/* Content */}
      <main className={`${activeTab === "jobs" ? "max-w-7xl" : "max-w-6xl"} mx-auto px-4 sm:px-6 lg:px-8 py-8 transition-all`}>
        {/* Tabs */}
                            ...
                            <div className="p-6">
                              ...
                              <div className="flex items-center gap-3 mb-6">
                                ...
                                {/*<Link
                                  ...
                                  className="inline-flex items-center gap-2 px-4 py-2.5 border border-border rounded-lg text-sm font-medium text-muted-foreground hover:text-foreground hover:bg-muted/50 transition-colors"
                                >
                                  <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
